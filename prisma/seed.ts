...
const productsData: Prisma.ProductCreateInput[] = [
  { uuid: randomUUID(), plu: 1, group: 'Starters', name: 'Miso Soup', image: '/placeholder/miso.jpeg', price: '7,00 €', allergies: '', description: '', details: '', page: 1, size: '', language: 'en' },
  { uuid: randomUUID(), plu: 2, group: 'Main', name: 'Braised Short Rib', image: '/placeholder/short-rib.jpg', description: 'Twelve-hour braised beef short rib with creamy polenta, gremolata, and red wine reduction.', allergies: '', details: '', page: 1, size: '', price: '42,00 €', language: 'en' },
  { uuid: randomUUID(), plu: 3, group: 'Main', name: 'Whole Grilled Lobster', image: '/placeholder/lobster.jpg', description: 'Maine lobster grilled over wood fire, served with drawn butter, corn on the cob, and coleslaw.', allergies: '', details: '', page: 1, size: '', price: '58,00 €', language: 'en' },
  { uuid: randomUUID(), plu: 4, group: 'Desserts', name: 'Panna cotta', image: '/placeholder/panna-cotta.jpeg', allergies: '', description: '', details: '', page: 1, size: '', price: '12,00 €', language: 'en' }
]
